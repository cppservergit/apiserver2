...
class nonce_error : public std::runtime_error {
public:
 ...
 * @throws std::invalid_argument if the secret is empty during initialization.
 */
...
/**
 * @brief Generates a cryptographically secure, signed nonce encoded in Base64URL.
 */
[[nodiscard]] std::string get_nonce();

/**
 * @brief Verifies the signature of a nonce generated by get_nonce().
 * @param nonce The nonce string to verify.
 * @return true if the signature is valid, false otherwise.
 */
[[nodiscard]] bool verify_nonce(std::string_view nonce);
...
namespace detail {
    ...
    public:
        ...
        [[nodiscard]] bool verify_nonce(std::string_view nonce) const;
