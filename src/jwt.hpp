 ...
 */
[[nodiscard]] std::expected<std::string, error_code> get_token(const std::map<std::string, std::string>& claims);
 ...
 */
[[nodiscard]] std::expected<std::map<std::string, std::string, std::less<>>, error_code> is_valid(std::string_view token);
 ...
 * @return A std::expected containing a map of the token's claims on success, or an error_code on failure.
 */
[[nodiscard]] std::expected<std::map<std::string, std::string, std::less<>>, error_code> get_claims(std::string_view token);
...
namespace detail {
    ...
    public:
        ...
        [[nodiscard]] std::expected<std::string, error_code> get_token(const std::map<std::string, std::string>& claims) const;
        [[nodiscard]] std::expected<std::map<std::string, std::string, std::less<>>, error_code> is_valid(std::string_view token) const;
        [[nodiscard]] std::expected<std::map<std::string, std::string, std::less<>>, error_code> get_claims(std::string_view token) const;
    
    private:
        [[nodiscard]] std::expected<std::map<std::string, std::string, std::less<>>, error_code> validate_and_decode(std::string_view token, bool verify_signature) const;
